...
@section('content')
<a href="{{ URL::route('home') }}">Dashboard</a> > Edit
<br /><h4>Edit Article</h4><br />
...
@endif
<form method="post" action="{{ URL::to('article/edit/'.$article->id) }}" role="form"> 
	...
	<div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
		...
		<textarea class="form-control" id="inputText" style="height:200px" placeholder="Write your article here" name="text">{{ $article->text }} </textarea>
		@if($errors->has('text'))
		<span class="help-block">
